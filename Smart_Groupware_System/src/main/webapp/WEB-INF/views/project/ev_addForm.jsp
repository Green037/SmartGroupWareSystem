...
<div class="sub-heard-part">
	<ol class="breadcrumb m-b-0">
		...
		<li class="active">평가보고서 등록</li>
	</ol>
</div>
<div class="container">
	<div class="row">
		<div class="col-md-12">
			<button class="btn btn-info orange-circle-button" id="evPrAddBtn">
				프로젝트<br />평가보고서<br /><span class="orange-circle-greater-than">작성!!</span>
			</button>
...
<div class="container" id="evPrForm" style="display:none;">
	<div class="row">
		<div class="col-md-12">
			<div class="panel panel-primary">
				<div class="panel-heading">
					<h3 class="panel-title">평가보고서 등록</h3>
					<span class="pull-right clickable"><i class="glyphicon glyphicon-chevron-up"></i></span>
				</div>
			<div class="panel-body">
				<form action="<c:url value='/ev/add'/>" method="post">
					...
					<div align="center">
						<button type="submit" class="btn-warning btn-lg" id="evAddBtn">
