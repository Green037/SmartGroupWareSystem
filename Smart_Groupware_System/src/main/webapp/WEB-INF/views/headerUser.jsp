								...
								<section class="panel">
									...
									<ul class="clock-category">
										<li><a href="#" class="active"> <img
												src="<c:url value='/resources/images/time.png'/>" alt=""> <span>Clock</span>
										</a></li>
										<li><a href="#"> <img
												src="<c:url value='/resources/images/alarm.png'/>" alt=""> <span>Alarm</span>
										</a></li>
										<li><a href="#"> <img
												src="<c:url value='/resources/images/watch.png'/>" alt=""> <span>Stop
													watch</span>
										</a></li>
										<li><a href="#"> <img
												src="<c:url value='/resources/images/timer.png'/>" alt=""> <span>Timer</span>
										</a></li>
									</ul>
								</section>
							</div>
