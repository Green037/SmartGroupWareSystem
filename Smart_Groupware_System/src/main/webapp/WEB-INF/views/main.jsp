...
<div class="row">
	...
	<div class="row">
		<div class="col-md-12">
			<!-- dred -->
			<br/><br/><br/>
			<a href="#" class="btn btn-primary" role="button" id="menualBtn"><span class="glyphicon glyphicon-list-alt glyphsize"></span> <br/><br/>사용설명서</a>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<a href="#" class="btn btn-primary" role="button" id="memberInfoBtn"><span class="glyphicon glyphicon-user glyphsize"></span><br/><br />팀원 소개</a>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<a href="#" class="btn btn-primary" role="button" id="projectInfoBtn"><span class="glyphicon glyphicon-folder-open glyphsize"></span> <br />프로젝트 <br />소개</a>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<a href="#" class="btn btn-primary" role="button" id="reviewBtn"><span class="glyphicon glyphicon-comment glyphsize"></span> <br/>프로젝트<br /> 후기</a>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<a href="<c:url value='/main/mainIndex'/>" class="btn btn-success" role="button" id="mainMoveBtn"><span class="glyphicon glyphicon-play-circle glyphsize"></span> <br/>메인페이지<br /> 이동</a>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		</div>
	</div>
</div>      
      ...
      <div class="col-md-4 col-md-offset-4">
        <div class="material-button-anim">
          <ul class="list-inline" id="options">
            ...
            <li class="option">
              <button class="material-button option2" type="button" id="projectInfoBtn" data-toggle="tooltip" data-placement="top" title="프로젝트소개">
                <span class="glyphicon glyphicon-duplicate" aria-hidden="true"></span>
              </button>
            </li>
            <li class="option">
              <button class="material-button option3" type="button" id="reviewBtn" data-toggle="tooltip" data-placement="right" title="프로젝트후기">
