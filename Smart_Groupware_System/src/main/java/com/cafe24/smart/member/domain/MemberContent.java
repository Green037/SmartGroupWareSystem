...
public class MemberContent {
	...
	public String toString() {
		return "MemberContent [mmCode=" + mmCode + ", ctCode=" + ctCode + ", ptCode=" + ptCode + ", dpCode=" + dpCode
				...
				+ ", mcSchoolName=" + mcSchoolName + ", mcAdmissionDate=" + mcAdmissionDate + ", mcGraduationDate="
				+ mcGraduationDate + ", mcMajor=" + mcMajor + ", mcJumsu=" + mcJumsu + ", mcGrade=" + mcGrade
				+ ", crCode=" + crCode + ", maCode=" + maCode + ", miCode=" + miCode + ", crData=" + crData
				+ ", crService=" + crService + ", crPastJoinDay=" + crPastJoinDay + ", crPastResignDay="
				+ crPastResignDay + ", crResponsibility=" + crResponsibility + ", mlCode=" + mlCode + ", lcCode="
				+ lcCode + ", mlIssueDate=" + mlIssueDate + "]";
	}
}
