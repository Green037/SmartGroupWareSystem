...
public class PaymentView {
	...
	public String toString() {
		return "PaymentView [paCode=" + paCode + ", pcCode=" + pcCode + ", cmCode=" + cmCode + ", mmDailyPay="
				+ mmDailyPay + ", inGruop=" + inGruop + ", paInsurance=" + paInsurance + ", paIncentive=" + paIncentive
				+ ", paSalary=" + paSalary + ", paSumSalary=" + paSumSalary + ", paEmployee=" + paEmployee
				+ ", paOwner=" + paOwner + ", finalSalary=" + finalSalary + ", paCalculateDate=" + paCalculateDate
